...
module.exports = function (config) {
  ...
  var title0 = ' | plotly.js' + (window.viewerTitle ? window.viewerTitle : '')

  var barContainer = h('div', {class: 'bar-container'}, [
    h('h3', h('a', {href: 'https://github.com/plotly/plotly.js', target: '_blank'}, title0))
  ])
